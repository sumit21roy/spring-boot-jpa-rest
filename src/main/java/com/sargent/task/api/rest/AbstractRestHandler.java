...
import com.sargent.task.domain.RestErrorInfo;
import com.sargent.task.exception.DataFormatException;
import com.sargent.task.exception.ResourceNotFoundException;
...
public abstract class AbstractRestHandler implements ApplicationEventPublisherAware {
    ...
    RestErrorInfo handleResourceNotFoundException(ResourceNotFoundException ex, WebRequest request, HttpServletResponse response) {
        ...
        return new RestErrorInfo(ex, "couldn't find it.");
    }
